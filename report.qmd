...
We are looking at data for four of the biggest South American countries: Argentina, Brazil, Chile, and Venezuela. Our data contains the gross percentage of enrollment of each type of education in the 2000s per year. For some countries, there is some data missing from a few years. Whether it was reported or not, we will take this lack of data into consideration in our analysis. To analyze this data, we will create scatter plots showing the trends in gross enrollment for each country and compare them side by side.
